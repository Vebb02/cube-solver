...
/* package cube-solver-0.1.0.0 */
#ifndef VERSION_cube_solver
#define VERSION_cube_solver "0.1.0.0"
#endif /* VERSION_cube_solver */
#ifndef MIN_VERSION_cube_solver
#define MIN_VERSION_cube_solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cube_solver */
...
#define CURRENT_COMPONENT_ID "cube-solver-0.1.0.0-inplace-cube-solver"
